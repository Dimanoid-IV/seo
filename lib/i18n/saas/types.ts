export type SaasDictionary = {
  ...
  integrations: {
    ...
    customWebsite: {
      title: string;
      description: string;
      copyDeveloperTask: string;
      copiedDeveloperTask: string;
      endpointStepTitle: string;
      endpointStepDescription: string;
      copyEndpointExample: string;
      copiedEndpointExample: string;
      testStepTitle: string;
      testStepDescription: string;
      publishStepTitle: string;
      publishStepDescription: string;
