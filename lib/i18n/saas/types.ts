export type SaasDictionary = {
  ...
  dashboard: {
    ...
    homeFlow: {
      ...
      runWebsiteCheck: string;
      checkingWebsite: string;
      auditRunningTitle: string;
      auditRunningDescription: string;
      needsFixTitle: string;
      needsFixDescription: string;
      topIssueLabel: string;
      generateFirstFix: string;
      generatingFix: string;
      generateFailed: string;
      generateNetworkError: string;
      hermesUnavailable: string;
      fixReadyTitle: string;
      fixReadyDescription: string;
      preview: string;
      copy: string;
      copySuccess: string;
      copyFailed: string;
