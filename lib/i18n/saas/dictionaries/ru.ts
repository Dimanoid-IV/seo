...
export const saasDictionary: SaasDictionary = {
  ...
  integrations: {
    ...
    customWebsite: {
      title: "Подключить свой сайт",
      description:
        "Если сайт не на WordPress, добавьте один защищённый адрес для публикации. После этого готовые статьи можно отправлять на сайт одной кнопкой.",
      copyDeveloperTask: "Скопировать задачу для разработчика",
      copiedDeveloperTask: "Инструкция скопирована",
      endpointStepTitle: "1. Адрес на сайте",
      endpointStepDescription: "Например /api/rankboost/articles.",
      copyEndpointExample: "Скопировать пример URL",
      copiedEndpointExample: "URL скопирован",
      testStepTitle: "2. Проверка связи",
      testStepDescription: "RankBoost отправляет тест без статьи.",
      publishStepTitle: "3. Публикация",
      publishStepDescription: "Готовая статья отправляется одной кнопкой.",
