...
export const saasDictionary: SaasDictionary = {
  ...
  integrations: {
    ...
    futureMentions: {
      title: "Упоминания и партнёрские возможности — позже",
      description:
        "В будущем RankBoost может подсказывать безопасные возможности для упоминаний. Без покупки ссылок, без схем и без обещаний позиций в Google.",
      badge: "Скоро",
    },
    executionHistory: {
