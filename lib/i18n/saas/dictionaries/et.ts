...
export const saasDictionary: SaasDictionary = {
  nav: {
    ...
    publicationCalendar: "Avaldamiskalender",
  ...
  integrations: {
    ...
    customWebsite: {
      title: "Avalda oma saidil",
      description:
        "Kui sait ei ole WordPressis, lisab arendaja ühe kaitstud avaldamise aadressi. Seejärel saab RankBoost valmis artiklid nupuga või kinnitatud kuuplaani järgi saidile saata.",
      copyDeveloperTask: "Kopeeri lühijuhend",
      copiedDeveloperTask: "Juhend kopeeritud",
      endpointStepTitle: "1. Arendaja lisab aadressi",
      endpointStepDescription: "Tavaliselt /api/rankboost/articles teie saidil.",
      copyEndpointExample: "Kopeeri näidis-URL",
      copiedEndpointExample: "URL kopeeritud",
      testStepTitle: "2. Testite ühendust",
      testStepDescription: "RankBoost saadab turvalise testi ilma artiklita.",
      publishStepTitle: "3. RankBoost avaldab",
      publishStepDescription: "Artikkel saadetakse nupuga või autopiloodiga.",
      addWebsiteFirst: "Lisage sait, et avaldamist seadistada.",
      endpointRequired: "Sisestage avaldamise URL.",
      testFailed: "Ühenduse test ebaõnnestus.",
      testNetworkError: "Võrguviga saidi testimisel.",
      testSuccess:
        "Sait ühendatud. Avage valmis artikkel ja klõpsake „Avalda saidil”.",
      disconnectSuccess: "Oma saidile avaldamine on välja lülitatud. Secret ja URL kustutati.",
      disconnectFailed: "Ühendust ei õnnestunud katkestada.",
      disconnectNetworkError: "Võrguviga ühenduse katkestamisel.",
      connectedTitle: "Saidile avaldamine on ühendatud",
      connectedDescription:
        "Kõik on valmis: avage valmis artikkel ja klõpsake „Avalda saidil”. RankBoost saadab materjali otse ühendatud blogisse. Täielikku URL-i ja secreti ei näidata.",
      secretSaved: "HMAC secret on salvestatud ja peidetud.",
      openReadyArticles: "Ava valmis artiklid",
      replaceEndpoint: "Vaheta aadress",
      disconnect: "Katkesta ühendus",
      currentlyConnected: (host) =>
        `Praegu ühendatud: ${host}. Sisestage uus URL uuesti testimiseks.`,
      endpointUrlLabel: "Avaldamise URL",
      sharedSecretLabel: "Allkirja shared secret",
      keepSecretPlaceholder: "Jätke tühjaks, et säilitada praegune secret",
      secretPlaceholder: "allkirja-secret",
      secretHiddenNote: "Secreti pärast salvestamist enam ei näidata.",
      testAndSave: "Testi ja salvesta",
      cancel: "Tühista",
      errorCopyInstruction: "Juhendit ei õnnestunud kopeerida.",
      errorCopyUrl: "URL-i ei õnnestunud kopeerida.",
      technicalDetails: "Mida arendajale saata",
      technicalIntro:
        "Endpoint peab vastu võtma POST JSON-i ja vastama HTTP 2xx. Test saadab event: \"rankboost.test\". Päris saatmine kasutab article.ready või site.fix.ready ainult pärast kasutaja selget tegevust või pärast Auto-publish lubamist kinnitatud kuuplaanis. URL-i ja secreti ei logita.",
      nextjsExample: "Valmis näide Next.js / Vercel jaoks",
      payloadExample: "Payload näide",
      headers: "Headers",
      successResponse: "Edukas vastus",
      hmacHeader: "HMAC päis X-RankBoost-Signature",
      fallbackHint:
        "Kui sait pole veel ühendatud, kasutage artiklikaardil universaalset HTML/Markdown/email paketti.",
      copyInstruction: "Kopeeri juhend arendajale",
      copiedInstruction: "Juhend kopeeritud",
    },
    brandVoice: {
      title: "Brändi stiil",
      description:
  ...
  publicationCalendar: {
    eyebrow: "Autopiloot",
    title: "Avaldamiskalender",
    subtitle:
      "Kõik kinnitatud plaani artiklid kuupäevade kaupa. Valmis artikli avamiseks ja kontrollimiseks klõpsake sellel.",
    loading: "Avaldamiskalendri laadimine…",
    loadFailed: "Avaldamiskalendrit ei õnnestunud laadida",
    openPlan: "Ava kuuplaan",
    scheduled: "Plaanitud",
    ready: "Artikleid valmis",
    published: "Avaldatud",
    nextPublication: "Järgmine avaldamine",
    noDate: "Pole veel",
    today: "Täna",
    previousMonth: "Eelmine kuu",
    nextMonth: "Järgmine kuu",
    approvedHint: "Plaan on kinnitatud. Autopiloot järgib neid kuupäevi.",
    draftHint: "Ajakava kinnitamiseks kinnitage kuuplaan.",
    emptyTitle: "Selleks kuuks pole avaldamisi plaanitud",
    emptyDescription:
      "Avage kuuplaan, valige teemad ja kinnitage ajakava. Seejärel ilmuvad artiklid siia kuupäevade kaupa.",
    preparing: "Artiklit valmistatakse ette",
    preparingDescription:
      "Teema on ajakavas, kuid artikli mustand pole veel valmis. Pärast loomist saab selle avada otse kalendrist.",
