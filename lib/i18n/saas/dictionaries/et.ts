...
export const saasDictionary: SaasDictionary = {
  ...
  integrations: {
    ...
    customWebsite: {
      title: "Ühenda oma sait",
      description:
        "Kui sait ei ole WordPressis, lisage üks kaitstud avaldamise aadress. Seejärel saab valmis artikleid ühe klõpsuga saidile saata.",
      copyDeveloperTask: "Kopeeri ülesanne arendajale",
      copiedDeveloperTask: "Juhend kopeeritud",
      endpointStepTitle: "1. Aadress saidil",
      endpointStepDescription: "Näiteks /api/rankboost/articles.",
      copyEndpointExample: "Kopeeri näidis-URL",
      copiedEndpointExample: "URL kopeeritud",
      testStepTitle: "2. Ühenduse test",
      testStepDescription: "RankBoost saadab testi ilma artiklita.",
      publishStepTitle: "3. Avaldamine",
      publishStepDescription: "Valmis artikkel saadetakse ühe klõpsuga.",
      ...
      technicalDetails: "Tehnilised detailid arendajale",
      technicalIntro:
