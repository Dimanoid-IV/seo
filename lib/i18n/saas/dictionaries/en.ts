...
export const saasDictionary: SaasDictionary = {
  ...
  integrations: {
    ...
    customWebsite: {
      title: "Connect your own site",
      description:
        "If your site is not WordPress, add one protected publishing address. After that, ready articles can be sent to your site with one click.",
      copyDeveloperTask: "Copy task for developer",
      copiedDeveloperTask: "Instructions copied",
      endpointStepTitle: "1. Address on your site",
      endpointStepDescription: "For example /api/rankboost/articles.",
      copyEndpointExample: "Copy example URL",
      copiedEndpointExample: "URL copied",
      testStepTitle: "2. Test connection",
      testStepDescription: "RankBoost sends a test without an article.",
      publishStepTitle: "3. Publish",
      publishStepDescription: "A ready article is sent with one click.",
      ...
      technicalDetails: "Technical details for developer",
      technicalIntro:
