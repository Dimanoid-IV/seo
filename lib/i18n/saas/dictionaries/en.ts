...
export const saasDictionary: SaasDictionary = {
  nav: {
    ...
    publicationCalendar: "Publishing Calendar",
  ...
  integrations: {
    ...
    googleAnalytics: {
      ...
      description:
        "Connect a GA4 property so RankBoost can see traffic, engagement, and conversions after publishing.",
      propertyId: "GA4 property ID",
      note:
        "Use the numeric property ID. Google account access uses the same safe OAuth flow as Search Console.",
      save: "Save property",
      sync: "Load data",
      saved: "GA4 property saved.",
      synced: "Google Analytics data loaded.",
      saveFailed: "Could not save GA4 property.",
      saveNetworkError: "Network error while saving GA4 property.",
      syncFailed: "Could not load Google Analytics.",
      syncNetworkError: "Network error while loading Google Analytics.",
      users: "Users",
      sessions: "Sessions",
      views: "Views",
    ...
    squarespace: {
      ...
      description:
        "Connect the public Squarespace site. RankBoost will prepare an HTML/Markdown/meta package and editor handoff.",
      siteUrl: "Squarespace site URL",
      blogUrl: "Blog page URL",
      note:
        "Squarespace does not offer an official blog publish API for direct autopublishing. RankBoost checks the site and prepares a safe package for the editor.",
      testAndSave: "Test and save",
      disconnect: "Disconnect",
      connected: "Squarespace connected. Ready articles can become publishing packages.",
      disconnected: "Squarespace disconnected.",
      connectFailed: "Squarespace connection failed.",
      connectNetworkError: "Network error while connecting Squarespace.",
      disconnectFailed: "Could not disconnect Squarespace.",
      disconnectNetworkError: "Network error while disconnecting Squarespace.",
    },
    ghost: {
    ...
    noCodeAutomation: {
      title: (provider) => `${provider} automation`,
      description: (provider) =>
        `Connect a ${provider} webhook. RankBoost will send ready articles to your no-code workflow.`,
      webhookUrl: "Webhook URL",
      sharedSecret: "Shared secret",
      sharedSecretPlaceholder: "Optional",
      tokenNote: (provider) =>
        `${provider} webhook URL and secret are encrypted and never shown again. RankBoost sends a test ping first.`,
      testAndSave: "Test and save",
      disconnect: "Disconnect",
      connected: (provider) => `${provider} connected.`,
      disconnected: (provider) => `${provider} disconnected.`,
      connectFailed: (provider) => `${provider} connection failed.`,
      connectNetworkError: (provider) =>
        `Network error while connecting ${provider}.`,
      disconnectFailed: (provider) => `Could not disconnect ${provider}.`,
      disconnectNetworkError: (provider) =>
        `Network error while disconnecting ${provider}.`,
    },
    gscPropertyPicker: {
    ...
    customWebsite: {
      title: "Publish on your own site",
      description:
        "For a non-WordPress site, your developer adds one protected publishing address once. After that, RankBoost can send ready articles with a button or through the approved monthly plan.",
      copyDeveloperTask: "Copy short instructions",
      copiedDeveloperTask: "Instructions copied",
      endpointStepTitle: "1. Developer adds an address",
      endpointStepDescription: "Usually /api/rankboost/articles on your site.",
      copyEndpointExample: "Copy example URL",
      copiedEndpointExample: "URL copied",
      testStepTitle: "2. You test the connection",
      testStepDescription: "RankBoost sends a safe test without an article.",
      publishStepTitle: "3. RankBoost publishes",
      publishStepDescription: "The article is sent by button or autopilot.",
      addWebsiteFirst: "Add a website to set up publishing.",
      endpointRequired: "Enter the publishing URL.",
      testFailed: "Connection test failed.",
      testNetworkError: "Network error while testing the site.",
      testSuccess:
        "Site connected. Open a ready article and click “Publish on site”.",
      disconnectSuccess: "Custom-site publishing disabled. Secret and URL deleted.",
      disconnectFailed: "Could not disconnect.",
      disconnectNetworkError: "Network error while disconnecting.",
      connectedTitle: "Publishing to your site is connected",
      connectedDescription:
        "Everything is ready: open a ready article and click “Publish on site”. RankBoost will send the material directly to the connected blog. The full URL and secret are not shown.",
      secretSaved: "HMAC secret is saved and hidden.",
      openReadyArticles: "Open ready articles",
      replaceEndpoint: "Replace address",
      disconnect: "Disconnect",
      currentlyConnected: (host) =>
        `Connected now: ${host}. Enter a new URL to test again.`,
      endpointUrlLabel: "Publishing URL",
      sharedSecretLabel: "Shared secret for signature",
      keepSecretPlaceholder: "Leave empty to keep the current secret",
      secretPlaceholder: "signature-secret",
      secretHiddenNote: "The secret is not shown again after saving.",
      testAndSave: "Test and save",
      cancel: "Cancel",
      errorCopyInstruction: "Could not copy the instructions.",
      errorCopyUrl: "Could not copy the URL.",
      technicalDetails: "What to send your developer",
      technicalIntro:
        "The endpoint must accept POST JSON and respond with HTTP 2xx. The test sends event: \"rankboost.test\". Real sends use article.ready or site.fix.ready only after an explicit user action or after Auto-publish is enabled in a confirmed monthly plan. URL and secret are not logged.",
      nextjsExample: "Ready example for Next.js / Vercel",
      payloadExample: "Payload example",
      headers: "Headers",
      successResponse: "Success response",
      hmacHeader: "HMAC header X-RankBoost-Signature",
      fallbackHint:
        "If the site is not connected yet, use the universal HTML/Markdown/email package in the article card.",
      copyInstruction: "Copy developer instructions",
      copiedInstruction: "Instructions copied",
    },
    brandVoice: {
      title: "Brand voice",
      description:
  ...
  publicationCalendar: {
    ...
    subtitle:
      "Every article in your approved plan, organized by date. Select a ready article to open and review it.",
    loading: "Loading publishing calendar…",
    loadFailed: "Could not load the publishing calendar",
    openPlan: "Open monthly plan",
    scheduled: "Scheduled",
    ready: "Articles ready",
    published: "Published",
    ...
    approvedHint: "The plan is approved. Autopilot follows these dates.",
    draftHint: "Approve the monthly plan to lock in this schedule.",
    emptyTitle: "No publications scheduled this month",
    emptyDescription:
      "Open the monthly plan, choose the topics, and approve the schedule. Articles will then appear here by date.",
    preparing: "Article is being prepared",
    preparingDescription:
      "The topic is scheduled, but the article draft is not ready yet. Once created, it will open directly from this calendar.",
