...
export const ErrorCode = {
  ...
  BILLING_STATE_LEGACY_OR_INVALID: "BILLING_STATE_LEGACY_OR_INVALID",
  BILLING_PORTAL_UNAVAILABLE: "BILLING_PORTAL_UNAVAILABLE",
...
const DEFAULT_STATUS_BY_CODE: Record<ErrorCode, number> = {
  ...
  [ErrorCode.BILLING_NOT_CONFIGURED]: 503,
  [ErrorCode.BILLING_STATE_LEGACY_OR_INVALID]: 409,
  [ErrorCode.BILLING_PORTAL_UNAVAILABLE]: 503,
  [ErrorCode.CHECKOUT_FAILED]: 502,
