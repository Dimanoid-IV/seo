...
> = {
  ...
  squarespace: {
    benefits: [
      ...
      "Честный guided workflow без фальшивого API-постинга",
    ],
    dataUsed: [
      "Публичный URL сайта и блога",
      "Готовые HTML/Markdown/meta материалы",
      "Execution history подготовки пакета",
    ],
    actions: [
      "Проверять доступность Squarespace сайта",
      "Готовить пакет для Squarespace editor",
      "Вести execution history",
    ],
    riskLevel: "medium",
    connectionPath: [
      "Указать URL сайта и страницы блога",
      "RankBoost проверяет публичную доступность",
      "Готовая статья получает Squarespace package",
      "Пользователь вставляет пакет в Squarespace editor",
    ],
  },
  ghost: {
    benefits: [
