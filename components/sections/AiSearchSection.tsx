  ...
  return (
    <section className="marketing-section">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="marketing-card mx-auto max-w-4xl bg-gradient-to-br from-[#c9bfff]/20 via-white to-violet-50">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
            <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-[#8169ff] shadow-[0_8px_24px_-8px_rgba(59,130,246,0.45)]">
