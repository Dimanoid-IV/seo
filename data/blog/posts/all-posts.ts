...
const articles: ArticleInput[] = [
  {
    ...
    slug: "google-bard-dlja-seo",
    title: "Google Bard для SEO: новые возможности и лучшие практики",
    metaTitle: "Google Bard для SEO: возможности и практики 2026",
    metaDescription: "Как использовать Google Bard и AI-инструменты Google для SEO: анализ интента, контент-брифы, структура страниц, E-E-A-T и контроль качества.",
    date: "2026-07-13",
    author: "RankBoost Team",
    category: "AI SEO",
    excerpt: "Практический разбор: где Bard полезен SEO-специалисту, где нужен ручной контроль и как встроить AI в процесс без потери качества.",
    tags: ["Google Bard для SEO", "AI SEO", "контент", "поисковая оптимизация"],
    content: [
      { type: "h2", text: "Короткий вывод" },
      { type: "p", text: "Google Bard и новые AI-инструменты Google полезны не как замена SEO-специалиста, а как ускоритель анализа, структуры и черновиков. Лучший результат появляется там, где AI помогает собрать варианты, а человек проверяет факты, интент, коммерческую ценность и соответствие бренду." },
      { type: "h2", text: "Где Bard помогает в SEO" },
      { type: "ul", items: ["Кластеризация запросов по интенту", "Создание контент-брифов для авторов", "Поиск пробелов в структуре страницы", "Генерация FAQ на основе реальных вопросов", "Черновики meta title и meta description", "Идеи для внутренней перелинковки"] },
      { type: "p", text: "Главное — не публиковать AI-текст без редакторской проверки. Для Google важны полезность, опыт, точность и доверие. Автоматически созданная страница без фактов и экспертности редко становится сильным SEO-активом." },
      { type: "h2", text: "Практический workflow" },
      { type: "ol", items: ["Соберите ключевые запросы из Search Console, Ahrefs, Semrush или подсказок Google.", "Попросите Bard разделить запросы на информационные, коммерческие и навигационные интенты.", "Сформируйте структуру статьи: H2, H3, FAQ, таблицы, примеры.", "Добавьте собственные данные: кейсы, цены, сроки, опыт команды, скриншоты.", "Проверьте факты вручную и удалите общие фразы.", "Опубликуйте страницу и измеряйте не позиции отдельно, а лиды, CTR и вовлечённость."] },
      { type: "h2", text: "Лучшие практики для 2026" },
      { type: "ul", items: ["Используйте AI для черновика, но экспертный слой пишите вручную", "Проверяйте даты, цифры и названия инструментов", "Не создавайте десятки похожих страниц без уникальной пользы", "Добавляйте внутренние ссылки на услуги, кейсы и контакты", "Оптимизируйте сниппет под конкретный интент", "Обновляйте статьи после изменений в SERP"] },
      { type: "h2", text: "Типичные ошибки" },
      { type: "p", text: "Самая частая ошибка — воспринимать Bard как фабрику готовых статей. Вторая ошибка — просить слишком общий текст без данных о рынке, продукте и целевой аудитории. Третья — забывать, что AI может уверенно формулировать неточные утверждения." },
      { type: "h2", text: "Как RankBoost использует AI безопасно" },
      { type: "p", text: "Мы применяем AI на этапах исследования, структуры, вариантов заголовков и проверки полноты. Финальные решения по стратегии, фактам, приоритетам и коммерческим CTA остаются за специалистом. Такой подход ускоряет производство контента, но не превращает сайт в набор одинаковых AI-страниц." },
      { type: "links", title: "Полезные материалы", items: [{ label: "SEO-услуги", href: "/ru/services" }, { label: "Core Web Vitals 2026", href: "/ru/blog/core-web-vitals-2026-kak-uluchshit-skorost-sajta" }, { label: "Контакты", href: "/ru/contact" }] },
      { type: "cta", title: "Хотите внедрить AI в SEO без риска?", description: "Закажите SEO-аудит — покажем, где AI ускорит рост, а где нужна ручная экспертная работа.", buttonLabel: "Получить аудит", href: "/ru/contact" }
    ],
    faq: [
      { question: "Можно ли писать SEO-статьи полностью через Bard?", answer: "Технически можно, но для стабильного результата нужен редакторский контроль: проверка фактов, интента, уникальной пользы, внутренних ссылок и коммерческих CTA." },
      { question: "Google наказывает за AI-контент?", answer: "Google оценивает полезность и качество, а не сам факт использования AI. Риск возникает, когда контент массовый, неточный, поверхностный или создан без пользы для пользователя." },
      { question: "Для каких задач Bard полезнее всего?", answer: "Для кластеризации запросов, структуры статей, FAQ, вариантов сниппетов и поиска пробелов. Стратегию и финальную экспертизу должен проверять специалист." }
    ]
  },
  {
    locale: "ru",
  ...
  {
    locale: "ru",
    translationKey: "core-web-vitals-2026",
    slug: "core-web-vitals-2026-kak-uluchshit-skorost-sajta",
    title: "Core Web Vitals 2026: как улучшить скорость сайта для роста позиций в Google",
    metaTitle: "Core Web Vitals 2026: скорость сайта и SEO",
    metaDescription: "Руководство по оптимизации Core Web Vitals в 2026 году: LCP, FID, CLS. Как улучшить скорость сайта для роста позиций в Google и повышения конверсии.",
    date: "2025-07-01",
    author: "RankBoost Team",
    category: "Technical SEO",
    excerpt: "Практические шаги по улучшению Core Web Vitals в 2026: диагностика проблем, инструменты для оптимизации, влияние на ранжирование и конверсию.",
    tags: [
      "Core Web Vitals",
      "скорость сайта",
    ...
    content: [
      {
        type: "h2",
        text: "Что такое Core Web Vitals в 2026"
      },
      {
        type: "p",
        text: "Core Web Vitals — набор ключевых метрик пользовательского опыта, которые Google использует для ранжирования сайтов. В 2026 году актуальны LCP (Largest Contentful Paint), FID (First Input Delay) и CLS (Cumulative Layout Shift)."
      },
      {
        type: "h2",
        text: "Как измерить и диагностировать проблемы"
      },
      {
        type: "p",
        text: "Используйте PageSpeed Insights, Lighthouse в DevTools или полевые данные из CrUX. Анализируйте отчёты по каждой метрике отдельно, чтобы понять, где ваши слабые места."
      },
      {
        type: "ul",
        items: [
          "LCP > 2.5s — нужно оптимизировать загрузку изображений, шрифтов, серверный рендеринг",
          "FID > 100ms — уменьшить блокирующие JavaScript-задачи",
          "CLS > 0.1 — избегать внезапных сдвигов макета"
        ]
      },
      {
        type: "h2",
        text: "Шаги по оптимизации LCP (Largest Contentful Paint)"
      },
      {
        type: "p",
        text: "LCP измеряет время загрузки самого крупного элемента на странице. Оптимизируйте:"
      },
      {
        type: "ol",
        items: [
          "Сжимайте изображения (WebP, AVIF)",
          "Используйте lazy loading для не‑видимых изображений",
          "Настройке кэширование на сервере (CDN, Vercel Edge)",
          "Минимизируйте блокирующий CSS и JavaScript"
        ]
      },
      {
        type: "h2",
        text: "Оптимизация FID (First Input Delay)"
      },
      {
        type: "p",
        text: "FID — задержка первого взаимодействия. Улучшения:"
      },
      {
        type: "ul",
        items: [
          "Разделите JavaScript на чанки (code splitting)",
          "Используйте веб‑воркеры для тяжёлых вычислений",
          "Отложите не‑критичные скрипты",
          "Минимизируйте сторонние виджеты"
        ]
      },
      {
        type: "h2",
        text: "Снижение CLS (Cumulative Layout Shift)"
      },
      {
        type: "p",
        text: "CLS измеряет неожиданные сдвиги макета. Решения:"
      },
      {
        type: "ol",
        items: [
          "Задавайте фиксированные размеры для изображений и рекламных блоков",
          "Избегайте вставки контента поверх существующего (pop‑ups)",
          "Используйте резервные шрифты или font‑display: swap",
    ...
    faq: [
      {
        question: "Как быстро можно улучшить Core Web Vitals?",
        answer: "Технические улучшения (оптимизация изображений, кэширование) дают результат за 1–2 недели. Архитектурные изменения (переход на более быстрый хостинг, изменение фреймворка) требуют месяцев."
      },
      {
        question: "Влияет ли скорость на конверсию?",
        answer: "Да, каждые 100 мс задержки могут снижать конверсию на 1–3%. Быстрые сайты увеличивают доверие и снижают отказы."
      },
      {
        question: "Нужно ли улучшать Core Web Vitals для мобильных и десктопов отдельно?",
        answer: "Да, Google использует мобильные данные для ранжирования, но десктоп‑версия тоже важна для пользовательского опыта. Оптимизируйте обе."
      }
    ]
  },
  {
    locale: "ru",
    translationKey: "google-ai-overviews-2024",
    slug: "google-ai-overviews-2024-kak-adaptirovat-seo",
    title: "Google AI Overviews 2024: как адаптировать SEO под новый поиск",
    metaTitle: "Google AI Overviews 2024: SEO в эпоху AI-поиска",
    metaDescription: "Полное руководство по адаптации SEO под Google AI Overviews и майский Core Update 2024: диагностика падения трафика, новые правила ранжирования, практические шаги для владельцев сайтов.",
    date: "2026-06-27",
    author: "RankBoost Team",
    category: "SEO Strategy",
    excerpt: "Разбор обновлений Google 19–21 мая 2024: переход от поиска ссылок к AI-ответам, портреты проигравших и победителей, 5 практических шагов для адаптации SEO.",
    tags: ["Google AI Overviews", "Core Update", "AI Search", "SEO 2024", "Google Algorithm", "трафик", "ранжирование"],
    content: [
      {
        type: "h2",
        text: "Что произошло 19–21 мая 2024: три слоя изменений"
      },
      {
        type: "p",
        text: "19 мая Google на конференции I/O представил новый поиск — не косметический апдейт, а фундаментальную перестройку логики. Раньше Google был посредником: вы задаёте вопрос, он даёт список сайтов. Теперь Google стремится решить задачу целиком: найти информацию, сравнить варианты, выбрать лучшее и выдать готовое решение."
      },
      {
        type: "p",
        text: "Параллельно Google объявил, что AI Mode превысил миллиард активных пользователей в месяц — это уже массовый продукт, а не эксперимент. 21 мая стартовал майский Core Update, меняющий сам алгоритм ранжирования."
      },
      {
        type: "p",
        text: "«Сейчас происходит не один апдейт, одновременно трясёт три слоя: как пользователь задаёт вопрос, что Google показывает в ответ, какие сайты Google считает достойными для попадания в этот ответ.» — Олег Шестаков, основатель Rush Agency"
      },
      {
        type: "h2",
        text: "Новый поиск: ответы вместо ссылок"
      },
      {
        type: "p",
        text: "Раньше запрос «Какую CRM выбрать для малого бизнеса?» возвращал 10 ссылок. Пользователь открывал 3–4 сайта, сравнивал и принимал решение."
      },
      {
        type: "p",
        text: "Теперь пользователь пишет естественный запрос: «Ищу CRM для отдела продаж на 6 человек, бюджет до 5.000 руб./месяц, нужна интеграция с Telegram и WhatsApp». Google понимает задачу, ограничения и то, что нужна не статья, а конкретная рекомендация."
      },
      {
        type: "p",
        text: "В ответе Google собирает таблицу сравнения, плюсы‑минусы, рекомендацию и иногда ссылки на источники. Пользователь получает готовый ответ прямо в выдаче и закрывает поиск."
      },
      {
        type: "h2",
        text: "Кто проиграет: три портрета в зоне риска"
      },
      {
        type: "h3",
        text: "1. Информационные сайты"
      },
      {
        type: "p",
        text: "Статьи вида «как выбрать», «топ‑10», «плюсы‑минусы» лучше всего закрываются AI‑ответами. Если пользователь приходит за информацией, а не за действием, страница в зоне риска."
      },
      {
        type: "h3",
        text: "2. Аффилиатные проекты"
      },
      {
        type: "p",
        text: "Сайты, зарабатывающие на подборках («лучший VPN», «лучший хостинг»), попадают под давление: Google сам прочитает десяток обзоров, поймёт, какой вариант чаще рекомендуют, назовёт победителя и даст ссылку на магазин напрямую."
      },
      {
        type: "h3",
        text: "3. Сайты с массовым AI‑контентом"
      },
      {
        type: "p",
        text: "Контент, сгенерированный ChatGPT без уникальной ценности, личного опыта, фактов или данных, теряет позиции и выпадает из поиска. AI‑ответам нужны оригинальные источники, а не пересказ чужих текстов."
      },
      {
        type: "h2",
        text: "Кто выиграет: новые герои поиска"
      },
      {
        type: "h3",
        text: "1. Бренды"
      ...
      {
        type: "p",
        text: "Брендовый спрос становится фактором выживания. Если вас ищут по названию, упоминают, на вас ссылаются и возвращаются, Google считает вас доверенным источником."
      },
      {
        type: "h3",
        text: "2. Сайты с реальной экспертизой"
      },
      {
        type: "p",
        text: "Кейсы, собственные сравнения, тесты, скриншоты, выводы специалистов — то, что AI не может просто пересказать. Опыт становится новым SEO‑активом."
      },
      {
        type: "h3",
        text: "3. Коммерческие сайты с нормальными посадочными"
      },
      {
        type: "p",
        text: "Google пока не может оказать услугу по ремонту квартиры или привезти диван. Поэтому трафик по запросам «купить», «заказать», «цена» остаётся, но конкуренция за него станет жёстче."
      },
      {
        type: "h2",
        text: "Диагностика падения трафика: три сценария"
      },
      {
        type: "p",
        text: "Откройте Google Search Console и сравните период до 19 мая и после."
      },
      {
        type: "ul",
        items: ["Упали показы — проблема с ранжированием (контент, релевантность, ссылки).", "Показы остались, упали клики — изменилась выдача (AI‑ответы забирают клики до перехода).", "Упали и показы, и клики — комбинация Core Update и новой логики поиска."]
      },
      {
        type: "h2",
        text: "5 практических шагов прямо сейчас"
      },
      {
        type: "ol",
        items: ["Разделите падение на позиции и клики в Search Console.", "Найдите страницы, которые Google может заменить AI‑ответом (информационные → перестраивайте в направленные на действие).", "Перепишите первые два абзаца на ключевых страницах — убрать воду, сразу давать ответ на интент.", "Добавьте уникальную ценность: тесты, скриншоты, таблицы, реальные цены, опыт внедрения.", "Работайте над брендом: известные становятся ещё известнее."]
      },
      {
        type: "h2",
        text: "Чек‑лист: не попал ли ваш сайт под «раздачу»?"
      },
      {
        type: "ul",
        items: ["Есть ли страницы с запросами «как выбрать», «топ‑10», «плюсы‑минусы»?", "Падает ли CTR при стабильных позициях?", "Используете ли вы массовый AI‑контент без уникальной экспертизы?", "Есть ли на сайте кейсы, тесты, собственные данные?", "Упоминают ли ваш бренд в сети (отзывы, статьи, соцсети)?"]
      },
      {
        type: "p",
        text: "Советы от экспертов: Не переписывайте весь сайт за выходные — Core Update раскатывается постепенно. Не удаляйте массово страницы — сначала диагностируйте, какие именно просели. Не закупайте тысячи ссылок — это может ухудшить ситуацию. Сначала данные, потом выводы, потом действия."
      },
      {
        type: "links",
      ...
      {
        type: "cta",
        title: "Нужна помощь с адаптацией SEO?",
        description: "Закажите бесплатный аудит — мы покажем, где именно вы теряете клики и как адаптировать сайт под AI‑поиск.",
    ...
    faq: [
      {
        question: "AI Overviews уже работают в русском поиске?",
        answer: "Да, Google постепенно внедряет AI‑ответы в русскоязычной выдаче, особенно по коммерческим и информационным запросам."
      },
      {
        question: "Можно ли вернуть трафик, если он уже упал?",
        answer: "Да, но нужно менять подход: добавлять уникальную экспертизу, переписывать вводные абзацы, усиливать бренд."
      },
      {
        question: "Стоит ли полностью удалять информационные статьи?",
        answer: "Нет, лучше переформатировать их в статьи‑гиды с чётким следующим шагом (калькулятор, сравнение, заявка)."
      },
    ]
  },
  {
    locale: "ru",
    translationKey: "seo-trends-2026",
    slug: "seo-trends-2026-ai-e-commerce-strategy",
    title: "SEO 2026: AI-трансформация e‑commerce и стратегия выживания",
    metaTitle: "SEO тренды 2026: как AI меняет электронную коммерцию",
    metaDescription: "Практический анализ: как Google AI Overviews, Core Update и EEAT меняют SEO для e‑commerce в 2026 году. Стратегия для владельцев интернет‑магазинов.",
    date: "2026-06-27",
    author: "RankBoost Team",
    category: "E-commerce SEO",
    excerpt: "Отказ от классических категорийных страниц, усиление UGC и авторских обзоров, интеграция AI‑поиска в пользовательские сценарии — ключевые изменения для e‑commerce в 2026.",
    tags: ["E-commerce SEO", "AI Search", "EEAT", "Google Update", "интернет‑магазин", "SEO стратегия"],
    content: [
      {
        type: "h2",
        text: "Три удара по e‑commerce SEO"
      },
      {
        type: "p",
        text: "Магазины, построенные на классической схеме «категория → подкатегория → товар», столкнулись с тройным давлением в 2026 году:"
      },
      {
        type: "ul",
        items: ["AI‑поиск напрямую отвечает на запросы «лучший [товар] для [цель]»", "Core Update ужесточил требования к экспертизе и авторитетности (EEAT)", "Пользователи всё меньше кликают на «обычные» товарные страницы"]
      },
      {
        type: "h2",
        text: "Что делать: 4 стратегических вектора"
      },
      {
        type: "h3",
        text: "1. От категорий к проблемам"
      },
      {
        type: "p",
        text: "Вместо страниц «Купить ноутбук» — «Какой ноутбук выбрать для дизайнера в 2026». Вместо «Купить кроссовки» — «Бег по асфальту: какие кроссовки подойдут для плоской стопы». AI‑поиск ищет ответы на задачи, а не просто товары."
      },
      {
        type: "h3",
        text: "2. UGC‑контент как новый SEO‑актив"
      },
      {
        type: "p",
        text: "Отзывы, видеообзоры, сравнения в реальных условиях, кейсы использования — всё, что показывает реальный опыт, получает преимущество в ранжировании. AI‑ответы заимствуют именно такие данные."
      },
      {
        type: "h3",
        text: "3. Интеграция AI‑поиска на сайте"
      },
      {
        type: "p",
        text: "Внедрите на сайте свой AI‑ассистент, который помогает подбирать товары по параметрам. Google видит такие сайты как полезные, а пользователи дольше остаются на странице."
      },
      {
        type: "h3",
        text: "4. Бренд как опорный сигнал"
      },
      {
        type: "p",
        text: "Чем больше упоминаний бренда вне сайта (отзывы, статьи, соцсети, видео), тем выше доверие Google. Инвестируйте в PR, коллаборации, экспертные выступления."
      },
      {
        type: "h2",
        text: "Практический чек‑лист для интернет‑магазина"
      },
      {
        type: "ol",
        items: ["Пересмотрите структуру навигации: от категорий к проблемным запросам", "Добавьте раздел «Экспертные подборки» с реальными тестами и сравнениями", "Внедрите AI‑ассистент по подбору товаров (можно через готовые решения)", "Собирайте и публикуйте видеоотзывы покупателей", "Проведите аудит EEAT‑сигналов: «кто автор», «почему доверять», «как это проверено»"]
      },
      {
        type: "links",
        title: "Полезные материалы",
        items: [
          {
            label: "SEO‑аудит для e‑commerce",
            href: "/ru/services/ecommerce"
          },
          {
            label: "Кейсы: рост трафика на 200%",
            href: "/ru/cases/ecommerce"
          },
        ]
      },
      {
        type: "cta",
        title: "Хотите адаптировать магазин под AI‑поиск?",
        description: "Закажите бесплатный SEO‑аудит — мы покажем точки роста и дадим пошаговый план.",
        buttonLabel: "Получить аудит для e‑commerce",
        href: "/ru/contact"
      },
    ],
    faq: [
      {
        question: "Нужно ли переписывать все товарные карточки?",
        answer: "Нет, только те, которые попадают под информационные запросы («как выбрать», «что лучше»). Фокус — на страницах, которые конкурируют с AI‑ответами."
      },
      {
        question: "Как быстро можно ожидать роста после изменений?",
        answer: "Первые сдвиги — через 2–3 недели, стабильный рост — через 2–3 месяца. AI‑поиск обучается быстрее, чем классический алгоритм."
      },
      {
        question: "Какие инструменты помогают отслеживать AI‑ответы?",
        answer: "Semrush, Ahrefs, Sistrix уже показывают позиции в AI Overviews. Плюс ручной мониторинг в Google Search Console по запросам."
      },
    ]
  },
  {
    locale: "ru",
    translationKey: "local-seo-estonia-2026",
    slug: "local-seo-estonia-2026-google-business-profile",
    title: "Local SEO в Эстонии 2026: как выжить в эпоху AI‑поиска",
    metaTitle: "Local SEO Эстония 2026: Google Business Profile, AI‑поиск, локальные факторы",
    metaDescription: "Актуальное руководство по локальному SEO для бизнесов в Эстонии: Google AI Overviews для местных запросов, оптимизация Google Business Profile, работа с отзывами и UGC‑контентом.",
    date: "2026-06-27",
    author: "RankBoost Team",
    category: "Local SEO",
    excerpt: "Как AI‑поиск меняет локальный поиск в Эстонии: новые возможности и риски для малого бизнеса. Стратегия работы с Google Business Profile и локальным контентом.",
    tags: ["Local SEO", "Эстония", "Google Business Profile", "AI Overviews", "локальный поиск", "отзывы"],
    content: [
      {
        type: "h2",
        text: "AI‑поиск и локальный бизнес: новая реальность"
      },
      {
        type: "p",
        text: "Раньше местные запросы («купить цветы в Таллине», «ремонт телефонов в Нарве») вели на карту Google Maps и список компаний. Теперь AI‑поиск анализирует профили, отзывы, часы работы, предлагает варианты и иногда рекомендует конкретное место без перехода на сайт."
      },
      {
        type: "h2",
        text: "Три угрозы для локального бизнеса"
      },
      {
        type: "h3",
        text: "1. AI‑ответы сокращают клики"
      },
      {
        type: "p",
        text: "Пользователь спрашивает «Где купить свежие овощи в Тарту?» и получает список магазинов с адресами и оценками прямо в выдаче — зачем заходить на сайты?"
      },
      {
        type: "h3",
        text: "2. Отсутствие обновлённого Google Business Profile"
      },
      {
        type: "p",
        text: "Профиль с устаревшими часами, старыми фото, без отзывов — слабый сигнал для AI. Google предпочитает аккуратные, активные, проверенные места."
      },
      {
        type: "h3",
        text: "3. Неправильная локальная семантика"
      },
      {
        type: "p",
        text: "Сайт не содержит страницы под запросы «услуга + город» на эстонском, русском и английском — AI не находит достаточной релевантности."
      },
      {
        type: "h2",
        text: "5 шагов для усиления локального SEO в 2026"
      },
      {
        type: "ol",
        items: ["Полностью заполните Google Business Profile: фото, видео, услуги, часы, Q&A.", "Активно собирайте отзывы: ответы на каждый отзыв, видеоотзывы, фото‑отчёты.", "Создайте на сайте посадочные страницы «услуга + город» на трёх языках (et, ru, en).", "Работайте с локальными СМИ и партнёрами — упоминания вне сети усиливают EEAT.", "Внедрите на сайте чат‑бота или AI‑ассистента для ответы на частые вопросы (без перехода в поиск)."]
      },
      {
        type: "h2",
        text: "Чек‑лист проверки локального SEO"
      },
      {
        type: "ul",
        items: ["Google Business Profile заполнен на 100% с подтверждённым адресом.", "Есть отзывы за последние 3 месяца (средний балл выше 4.5).", "На сайте есть тексты на эстонском под локальные запросы.", "Внутренняя перелинковка со страницы города на основные услуги.", "Аналитика отслеживает звонки и заявки из локального поиска."]
      },
      {
        type: "links",
        title: "Полезные материалы",
        items: [
          {
            label: "Бесплатный аудит Google Business Profile",
            href: "/ru/services/local-seo"
          },
          {
            label: "Кейсы: рост трафика в 3 раза",
            href: "/ru/cases/local-seo"
          },
        ]
      },
      {
        type: "cta",
        title: "Нужна помощь с локальным SEO в Эстонии?",
        description: "Закажите бесплатный аудит — мы проверим профиль, сайт и дадим пошаговый план.",
        buttonLabel: "Получить аудит по локальному SEO",
        href: "/ru/contact"
      },
    ],
    faq: [
      {
        question: "AI‑поиск уже влияет на локальную выдачу в Эстонии?",
        answer: "Да, с июля 2026 Google тестирует AI‑ответы для запросы «где купить», «где поесть», «услуги в городе». Особенно заметно в Таллине и Тарту."
      },
      {
        question: "Сколько отзывов нужно для хорошего ранжирования?",
        answer: "Качество важнее количества: 20 свежих (последние 6 месяцев) развёрнутых отзывов с ответами владельца лучше, чем 100 старых."
      },
      {
        question: "Какие языки приоритетны для бизнеса в Эстонии?",
        answer: "Эстонский — обязателен, русский — для Нарвы, Йыхви, Таллина (северо‑восточные районы), английский — для туристических услуг и стартапов."
      },
    ]
  }
];
