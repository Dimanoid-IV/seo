...
export const dictionary: Dictionary = {
  ...
  blog: {
    ...
    min: "min",
    related: "Sarnased artiklid",
    backToBlog: "← Kõik artiklid",
    allArticles: "Kõik artiklid",
    noArticles: "Selles kategoorias artikleid pole",
    allCategories: "Kõik",
  },
  contact: {
    ...
    info: {
      title: "Kontaktandmed",
      email: "Email",
      response: "Vastamise aeg",
      responseTime: "24 tunni jooksul tööpäevadel",
    },
    serviceTypes: {
      "seo-audit": "SEO audit",
      "technical-seo": "Tehniline SEO",
      "local-seo": "Kohalik SEO",
      "ecommerce-seo": "E-poe SEO",
      "content-seo": "SEO sisu ja artiklid",
      "multilingual-seo": "Mitmekeelne SEO",
      "landing-pages": "Maandumislehtede optimeerimine",
      "new-sites": "SEO uuele veebilehele",
      other: "Muu",
    },
    plans: {
      start: "Start SEO",
      ...
      growth: "Growth SEO",
      partner: "SEO Partner",
      "not-sure": "Pole veel otsustanud",
    },
    budgets: {
      "under-200": "kuni 200 € / kuus",
      "200-500": "200–500 € / kuus",
      "500-1000": "500–1000 € / kuus",
      "over-1000": "üle 1000 € / kuus",
      "not-sure": "Ei tea veel",
    },
  },
  footer: {
    description:
