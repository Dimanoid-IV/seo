...
export const dictionary: Dictionary = {
  ...
  solution: {
    ...
    subtitle:
      "Платформа находит возможности и готовит планы, задачи и статьи на проверку — вы решаете, что публиковать.",
    items: [
      {
      ...
      {
        title: "Готовит планы и статьи",
        description:
          "Месячный план, SEO-задачи и черновики статей — готовы к вашей проверке.",
      },
      {
        title: "Сначала проверка, потом публикация",
        description:
          "Ничего не публикуется без вашего подтверждения. Для своего сайта — экспорт, копирование и передача разработчику.",
      },
      {
  ...
  outputs: {
    ...
    subtitle:
      "Планы, задачи и статьи в режиме проверки — публикация только после вашего одобрения.",
    items: [
      "SEO-задачи",
      "Месячный план роста",
      "Черновики статей",
      ...
      "Экспорт для своего сайта",
      "Проверки готовности к AI-поиску",
    ],
    trustNote:
      "Начните с проверки. Автопубликация — только после явного включения и подключённых интеграций. Для custom-сайтов RankBoost даёт экспорт и handoff разработчику.",
  },
  aiSearch: {
  ...
  pricing: {
    ...
    pageSubtitle:
      "Начните бесплатно. Перейдите на платный план, когда понадобится больше действий и черновиков. Публикация — только после вашей проверки. Без гарантий позиций в Google.",
